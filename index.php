            ...
            <div class="all-helper-info-index">
                <div class="helper-individual-index">
                    <div class="helper-group helper0">
                        ...
                        <div class = "helper-more-about">
                            <p class="name"><b>Allison Argent</b></p>
                            <p class="hierarchy">CEO - Malako Bakery Shop</p>
                            <p class="description">Delivers best sweet cake for sweet customers.</p>
                        </div>
                ...
                <div class="helper-individual-index">
                    <div class="helper-group helper1">
                        ...
                        <div class = "helper-more-about">
                            <p class="name"><b>Paul Walker</b></p>
                            <p class="hierarchy">CO-FOUNDER</p>
                            <p class="description">Jelly topping makes the cake smooth like coffee.</p>
                        </div>
                ...
                <div class="helper-individual-index">
                    <div class="helper-group helper2">
                        ...
                        <div class = "helper-more-about">
                            <p class="name"><b>Abraham Linkan</b></p>
                            <p class="hierarchy">MASTER BAKER</p>
                            <p class="description">Master chef 2020, holder best baker of 2021 in Mumbai.</p>
                        </div>
